...
import com.boyuanitsm.pay.alipay.sign.MD5;
...
public class AlipaySubmit {
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(String outTradeNo, String subject, String totalFee, String body) throws Exception {
        //把请求参数打包成MAP
        ...
        //建立请求
        String ss = AlipaySubmit.buildRequest(sParaTemp, "post", "确认");
